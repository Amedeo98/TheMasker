...
//==============================================================================
const juce::String TheMaskerAudioProcessor::getName() const
{
    return JucePlugin_Name;
}

bool TheMaskerAudioProcessor::acceptsMidi() const
{
...
bool TheMaskerAudioProcessor::producesMidi() const
{
...
bool TheMaskerAudioProcessor::isMidiEffect() const
{
   #if JucePlugin_IsMidiEffect
    return true;
   #else
...
double TheMaskerAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}

int TheMaskerAudioProcessor::getNumPrograms()
{
    return 1;   // NB: some hosts don't cope very well if you tell them there are 0 programs,
                // so this should be at least 1, even if you're not really implementing programs.
}

int TheMaskerAudioProcessor::getCurrentProgram()
{
    return 0;
}

void TheMaskerAudioProcessor::setCurrentProgram (int index)
{
}

const juce::String TheMaskerAudioProcessor::getProgramName (int index)
{
    return {};
}

void TheMaskerAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}
...
//==============================================================================
bool TheMaskerAudioProcessor::hasEditor() const
{
